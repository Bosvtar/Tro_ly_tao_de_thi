  ...
  return (
    <div className="min-h-screen print:bg-white bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
            ...
            {/* Resizer Handle */}
            <div 
              className="w-1.5 bg-gray-200 hover:bg-indigo-400 cursor-col-resize hidden lg:flex items-center justify-center transition-colors z-20 hover:w-2 -ml-1"
            ...
            {/* Main Content Area */}
            <div className="flex-1 p-4 lg:p-8 overflow-y-auto lg:h-[calc(100vh-65px)] custom-scrollbar">
                {error && (
